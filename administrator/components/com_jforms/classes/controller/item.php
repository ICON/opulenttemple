...
class JformsCkClassControllerItem extends JControllerForm
{
	...
	*/
	public function save($key = null, $urlVar = null)
	{
		...
		$this->postSaveHook($model, $data, $form);
...
JLoader::register('JformsClassControllerItem', JPATH_ADMIN_JFORMS .DS. 'fork' .DS. 'classes' .DS. 'controller' .DS. 'item.php');
JLoader::load('JformsClassControllerItem'); /* To load class in memory */
