...
* @subpackage	Class
*/
class JformsCkClassLoader extends JLoader
{
	/**
	...
	*/
	public static function setup($enablePsr = true, $enablePrefixes = true, $enableClasses = true, $enableComponentLoader = false)
	{
		...
		if ($enableComponentLoader)
			spl_autoload_register(array('JformsClassLoader', 'load'));
	}
...
if (!class_exists('JformsClassLoader')){ class JformsClassLoader extends JformsCkClassLoader{} }
