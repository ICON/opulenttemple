...
if (!defined('JFORMS_IMAGES_ALOWED_SIZES')) define("JFORMS_IMAGES_ALOWED_SIZES", '50x50');
...
if (file_exists(JPATH_ADMIN_JFORMS .DS. "classes" .DS. "file" .DS. "file.php"))
	include_once(JPATH_ADMIN_JFORMS .DS. "classes" .DS. "file" .DS. "file.php");


class JformsImages  extends JformsClassFile
{
...
*/
	...
	{
		$this->width = min($width, JFORMS_IMAGES_MAX_WIDTH);
	}

    function height($height='') {
        $this->height = min($height, JFORMS_IMAGES_MAX_HEIGHT);
    }
