	...
	function getTemplate()
	{
		...
		if ($layout == 'default')
		{
			...
			foreach ($submissions as $SubmissionId => $submission)
			{
				...
				$with 	 = array_merge($with, array($submission['UserIp'], RSFormProHelper::getDate($submission['DateSubmitted']), $SubmissionId, $SubmissionId, $pagination->getRowOffset($i), '<a href="'.$details_link.'">', '<a href="'.$pdf_link.'">', $submission['confirmed'], $details_link, $pdf_link));
